...
// ***********************************************************************
// <copyright file="Technique.cs" company="Guilherme Branco Stracini ME">
...
/// <summary>
/// Class Technique. This class cannot be inherited.
/// Implements the <see cref="IEntity" />
/// Implements the <see cref="IEquatable{Technique}" />
/// </summary>
/// <seealso cref="IEntity" />
/// <seealso cref="IEquatable{Technique}" />
[Entity("VTEXTECNICAS")]
public sealed class Technique : IEntity, IEquatable<Technique>
{
    ...
    public bool Equals(Technique other)
    {
        if (other is null)
        {
            return false;
    ...
    public override bool Equals(object obj)
    {
        ...
        return ReferenceEquals(this, obj) || obj is Technique other && Equals(other);
    }
    ...
    public static bool operator ==(Technique left, Technique right) => Equals(left, right);
