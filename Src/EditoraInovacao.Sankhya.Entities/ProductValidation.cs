...
public static class ProductValidation
{
    ...
    /// </summary>
    public static readonly Regex ProductCodeAndNamePattern =
        new(
            @"""(?<code>\d+)\s-\s(?<name>.+)""",
    ...
    /// </summary>
    public static readonly Regex InvalidDescriptionPattern =
        new(
            @"^(\r\n)?(DESCRIÇÃO\:?(\r\n){0,2})?",
            RegexOptions.IgnoreCase | RegexOptions.CultureInvariant | RegexOptions.Compiled
        );
    ...
    /// </summary>
    public static readonly Regex VimeoVideoPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex OnlineCourseAttachmentPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex InvalidNcmPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex InvalidOriginPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex InvalidCfopPattern =
        new(
